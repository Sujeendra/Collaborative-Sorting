...
(cl:in-package ik_trajectory_tutorial-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteCartesianIKTrajectory-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteCartesianIKTrajectory-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ik_trajectory_tutorial-srv:<ExecuteCartesianIKTrajectory-request> is deprecated: use ik_trajectory_tutorial-srv:ExecuteCartesianIKTrajectory-request instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ExecuteCartesianIKTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ik_trajectory_tutorial-srv:header-val is deprecated.  Use ik_trajectory_tutorial-srv:header instead.")
  (header m))

(cl:ensure-generic-function 'poses-val :lambda-list '(m))
(cl:defmethod poses-val ((m <ExecuteCartesianIKTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ik_trajectory_tutorial-srv:poses-val is deprecated.  Use ik_trajectory_tutorial-srv:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExecuteCartesianIKTrajectory-request>)))
  ...
  "ik_trajectory_tutorial/ExecuteCartesianIKTrajectoryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExecuteCartesianIKTrajectory-request)))
  "Returns string type for a service object of type 'ExecuteCartesianIKTrajectory-request"
  "ik_trajectory_tutorial/ExecuteCartesianIKTrajectoryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteCartesianIKTrajectory-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteCartesianIKTrajectory-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ik_trajectory_tutorial-srv:<ExecuteCartesianIKTrajectory-response> is deprecated: use ik_trajectory_tutorial-srv:ExecuteCartesianIKTrajectory-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ExecuteCartesianIKTrajectory-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ik_trajectory_tutorial-srv:success-val is deprecated.  Use ik_trajectory_tutorial-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExecuteCartesianIKTrajectory-response>)))
  ...
  "ik_trajectory_tutorial/ExecuteCartesianIKTrajectoryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExecuteCartesianIKTrajectory-response)))
  "Returns string type for a service object of type 'ExecuteCartesianIKTrajectory-response"
  "ik_trajectory_tutorial/ExecuteCartesianIKTrajectoryResponse")
